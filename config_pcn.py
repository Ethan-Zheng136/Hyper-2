...
__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '/home/guantian/SVDFormer_PointSea/data/PCN/%s/partial/%s/%s/%02d.pcd'
__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '/home/guantian/SVDFormer_PointSea/data/PCN/%s/complete/%s/%s.pcd'
...
__C.DIR                                          = edict()
__C.DIR.OUT_PATH                                 = '/data/Ethan-Zheng/SVDFormer/output/hyper/PCN'
__C.CONST.DEVICE                                 = '0'
__C.CONST.WEIGHTS                                = '/data/Ethan-Zheng/SVDFormer/output/hyper/PCN/checkpoints/2025-06-10T12:53:46.785347/ckpt-best.pth'
...
__C.TRAIN.LEARNING_RATE                          = 3.4299999999999993e-05
